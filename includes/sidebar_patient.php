<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="appointments.php" class="nav-item <?php echo ($current_page == 'appointments') ? 'active' : ''; ?>">📅 My Appointments</a>
        <a href="book-appointment.php" class="nav-item <?php echo ($current_page == 'book-appointment') ? 'active' : ''; ?>">➕ Book New</a>

        <p class="nav-section">Health Records</p>
        <a href="medical-records.php" class="nav-item <?php echo ($current_page == 'medical-records') ? 'active' : ''; ?>">📋 Medical Records</a>
        ...
        <a href="billing.php" class="nav-item <?php echo ($current_page == 'billing') ? 'active' : ''; ?>">💳 Bills & Payments</a>

        <p class="nav-section">Account</p>
        <a href="profile.php" class="nav-item <?php echo ($current_page == 'profile') ? 'active' : ''; ?>">👤 My Profile</a>
        <a href="notifications.php" class="nav-item <?php echo ($current_page == 'notifications') ? 'active' : ''; ?>">🔔 Notifications</a>
    </nav>
