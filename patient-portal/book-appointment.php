...
<div class="main-content">
    ...
    <main class="page-content">
        ...
        <form method="POST">
            ...
            <div class="card">
                <div class="card-header"><h3 class="card-title">Step 1: Select Doctor</h3></div>
                <div class="form-group">
                    ...
                    <select name="doctor_id" class="form-select" required>
                        ...
                        <?php endforeach; ?>
                        <?php if ($current_spec !== '') echo '</optgroup>'; ?>
                    </select>
                </div>
            </div>

            <div class="card">
                <div class="card-header"><h3 class="card-title">Step 2: Select Date & Time</h3></div>
                <div class="grid-2">
                    <div class="form-group">
                ...
                <p class="text-sm text-gray">Note: Appointments are subject to availability. You will receive a confirmation.</p>
            </div>

            <div class="card">
                <div class="card-header"><h3 class="card-title">Step 3: Reason for Visit</h3></div>
                <div class="form-group">
                    <label class="form-label">Brief description of your concern</label>
                    <textarea name="reason" class="form-textarea" rows="3" placeholder="e.g., Annual check-up, headache for 3 days, follow-up for blood pressure..."></textarea>
                </div>
            </div>
