...
<div class="main-content">
    ...
    <main class="page-content">
        ...
        <div class="tabs">
            <button class="tab active" onclick="switchTab('pending')">Pending Tests
        ...
        <!-- Result Entry Modal -->
        <div id="resultModal" class="card"
            style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1000; width: 500px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">
            <div class="card-header">
