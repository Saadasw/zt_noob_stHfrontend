...
<div class="main-content">
    ...
    <main class="page-content">
        ...
        <div class="tabs">
            <button class="tab active">Pending Prescriptions (<?php echo count($pending); ?>)</button>
            <button class="tab">Inventory</button>
        </div>

        <div class="card">
            <div class="card-header"><h3 class="card-title">Pending Prescriptions</h3></div>
            
            <?php foreach ($pending as $rx): ?>
            <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin-bottom: 12px;">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        <div style="font-weight: 600; font-size: 16px;">💊 <?php echo h($rx['prescription_no']); ?></div>
                ...
                <div style="margin-top: 12px; background: #f9fafb; padding: 12px; border-radius: 4px;">
                    ...
                    <ul style="margin: 8px 0 0 20px;">
                        ...
                        <li><?php echo h($item['medicine_name']); ?> - <?php echo h($item['dosage']); ?> - <?php echo h($item['frequency']); ?> x <?php echo h($item['duration']); ?> (Qty: <?php echo $item['quantity']; ?>)</li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                ...
                <div class="flex gap-2 mt-4">
                    <form method="POST" style="display:inline;">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary" onclick="return confirm('Confirm dispensing this prescription?');">✅ Dispense All</button>
                    </form>
        ...
        <div class="card">
            <div class="card-header"><h3 class="card-title">Medicine Inventory (Sample)</h3></div>
