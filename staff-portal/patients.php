...
if ($active_tab === 'search') {
    ...
    if ($search) {
        $sql = "SELECT p.*, u.name, u.email, u.phone 
                ...
                WHERE u.name LIKE ? OR p.patient_id LIKE ? OR u.phone LIKE ?";
...
<div class="main-content">
    ...
    <main class="page-content">
        ...
        <div class="tabs">
            <a href="?tab=register" class="tab <?php echo $active_tab === 'register' ? 'active' : ''; ?>">Register New</a>
        ...
        <div class="card">
            ...
            <form method="GET" class="form-group">
                ...
                <div class="flex gap-2">
                    <input type="text" name="search" class="form-input" placeholder="🔍 Enter patient name, ID, or phone..."
                        style="flex: 1;" value="<?php echo h($_GET['search'] ?? ''); ?>">
                ...
                <div class="patient-card">
                    <div class="patient-header">
                        <div>
                            ...
                            <div class="patient-meta"><?php echo h($p['patient_id']); ?> | <?php echo h($p['phone']); ?></div>
                            <div class="patient-meta">DOB: <?php echo h($p['date_of_birth']); ?> | <?php echo h($p['gender']); ?> | Blood: <?php echo h($p['blood_group']); ?></div>
                        </div>
                    </div>
                    <div class="flex gap-2 mt-4">
                        <a href="profile_view.php?id=<?php echo $p['user_id']; ?>" class="btn btn-sm btn-outline">View Profile</a>
                        <a href="appointments.php?patient_id=<?php echo $p['patient_id']; ?>" class="btn btn-sm btn-outline">Book Appointment</a>
                        <a href="billing.php?patient_id=<?php echo $p['patient_id']; ?>" class="btn btn-sm btn-outline">Create Bill</a>
                    </div>
                </div>
                <?php endforeach; ?>
            <?php else: ?>
